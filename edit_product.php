...
<head>
    ...
    <link rel="stylesheet" href="/fashion/css/edit_product.css?v=<?php echo time(); ?>">
</head>
<body>
    <h2>Edit Product</h2>
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <p>Current Image:</p>
        <img src="images/<?php echo htmlspecialchars($product['image']); ?>" width="100" alt="Product Image">
